...
if (!defined('__SERVICE__')) {
	...
	while (!$rs->EOF) {
		...
		$obj->inventorymovingdetil_idr = 1*$mul*$rs->fields['inventorymovingdetil_idr'];	
		$obj->inventorymovingdetil_idrsubtotal = 1*$rs->fields['inventorymovingdetil_qty']*$rs->fields['inventorymovingdetil_idr'];
		...
		//print $obj->inventorymovingdetil_qtyinit."-";

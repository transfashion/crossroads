...
customer traffic
Filename: uitrncusttraffic-delete.php
*/
	...
	try {
		...
		$conn->Execute(sprintf("DELETE FROM %s WHERE %s='%s'", $__CONF['D']['transaksi_custtrafficdetil']['TABLE_NAME'], $__CONF['D']['transaksi_custtrafficdetil']['PRIMARY_KEY1'], $__ID));

...
if (is_array($objCriteria)) {
	...
	SQLUTIL::BuildCriteria(&$SQL_CRITERIA, $criteria, 'obj_search_chk_hemoving_islogisticpost', 'hemoving_islogisticpost', " %s = '%s' ");
...
while (!$rs->EOF) {
	...
	$obj->hemoving_islogisticpost = $rs->fields['hemoving_islogisticpost'];

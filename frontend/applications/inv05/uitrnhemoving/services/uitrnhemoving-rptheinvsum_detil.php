...
if (!defined('__SERVICE__')) {
	...
	$sql = "
		...
		ORDER BY REPSEQ, heinvgro_id, heinvctg_id, REPSECTIONSEQ, heinv_art
	...
	*/
	...
	$sql = "
		...
		WHERE 
		      cacheid='$cacheid' 
		AND (REPSECTIONLINE>$rowstart AND REPSECTIONLINE<=$rowend)
		ORDER BY REPSECTIONLINE
	";	
...
*/
		...
		$obj->heinv_pricenett = (float) $rs->fields['heinv_pricenett']; 
		$obj->heinv_pricevalue = (float) $rs->fields['heinv_pricevalue']; 
		$obj->heinv_cost = (float) $rs->fields['heinv_cost']; 
		$obj->heinv_costvalue = (float) $rs->fields['heinv_costvalue']; 

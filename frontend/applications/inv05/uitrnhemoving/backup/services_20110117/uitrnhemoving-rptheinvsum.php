...
if (is_array($objCriteria)) {
	...
	if ($branch_id) {
			...
			$sql = "
				...
				EXEC inv05he_RptSummaryByBranchCtg @date_start, @date_end, @region_id, @branch_id, @heinvgro_id, @heinvctg_id, 0, NULL, 0
			";	
			...
			$sql = "
				...
				EXEC inv05he_RptSummaryAllBranchCtg @date_start, @date_end, @region_id, @heinvgro_id, @heinvctg_id, 0, NULL, 0
			";	
	}

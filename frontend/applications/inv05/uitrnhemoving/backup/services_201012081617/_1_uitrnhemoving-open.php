...
if (!defined('__SERVICE__')) {
	...
	while (!$rs->EOF) {
		...
		$obj->heinv_subtotal = 1 * $obj->heinv_qtyrecv * (((100-$obj->heinv_disc)/100) * $obj->heinv_price);
		$obj->heinv_priceidr = 1 * $objh->currency_rate * $rs->fields['heinv_price'];
		$obj->heinv_subtotalidr = 1 * $objh->currency_rate * $obj->heinv_subtotal;

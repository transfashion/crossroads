<?php
	...
	$__CONF['D']['DetilItemFG']['TABLE_NAME']		= "transaksi_hemovingdetil";
	$__CONF['D']['DetilItemFG']['PRIMARY_KEY1']		= "hemoving_id";
	$__CONF['D']['DetilItemFG']['PRIMARY_KEY2']		= "hemovingdetil_line";
	
	$__CONF['D']['DetilItemRM']['TABLE_NAME']		= "transaksi_hemovingdetil";
	$__CONF['D']['DetilItemRM']['PRIMARY_KEY1']		= "hemoving_id";
	$__CONF['D']['DetilItemRM']['PRIMARY_KEY2']		= "hemovingdetil_line";

...
if (is_array($objCriteria)) {
	...
	SQLUTIL::BuildCriteria(&$SQL_CRITERIA, $DB_CRITERIA, 'obj_chk_masterdata_name', 'heorder_descr', " (oc_id='{criteria_value}' OR {db_field} LIKE '%{criteria_value}%') ");
...
$sql = "
		...
		BEGIN
				...
				WHERE heorder_isposted=1 AND heorder_isclosed=0 
					  AND $SQL_CRITERIA

...
if (!defined('__SERVICE__')) {
	...
	while (!$rs->EOF) {
		...
		if ($obj->heinv_id) {
			...
			if ($register_heinvctg_id!=$obj->heinvctg_id) {
				$register_heinvctg_beda = true;
			}
		} 

		$sql = "select heinvctg_name, heinvctg_sizetag, heinvgro_id, heinvctg_isdisabled, heinvctg_isinactive from master_heinvctg where heinvctg_id='$obj->heinvctg_id' and region_id='$obj->region_id' ";
		$rsI = $conn->Execute($sql);

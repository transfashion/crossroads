...
if (!defined('__SERVICE__')) {
	...
	$data = array();
	if ($coverage=='REGION') {
		$sql = "EXEC inv05_RptSummaryInvPerItem_SelectAllBranch '$ids', '|', '$datestart', '$dateend', '$includeconsumable'";
	} else {
		$sql = "EXEC inv05_RptSummaryInvPerItem_SelectMultiByBranch '$ids', '|', '$datestart', '$dateend', '$branch_id', '$includeconsumable'";
	}

...
if (!defined('__SERVICE__')) {
	...
	if (is_array($objCriteria)) {
		...
		$switch = SQLUTIL::BuildCriteria($param, $CRITERIA_DB, 'obj_search_chk_inventory_type', '', "{criteria_value}");
		
		$switch = substr($switch,0,2);
...
SET @day = '$tgl';
		...
		EXEC poshe_RptSalesSummary_1 '$region_id',@startdate, @enddate,@day ";
		$rs  = $conn->Execute($sql);

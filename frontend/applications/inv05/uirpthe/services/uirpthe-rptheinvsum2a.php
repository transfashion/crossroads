...
if (is_array($objCriteria)) {
	...
	while (list($name, $value) = each($objCriteria)) {
		...
		$area_id   	 = SQLUTIL::BuildCriteria($param, $CRITERIA_DB, 'obj_search_chk_inventory_area_id', '', "{criteria_value}");
...
{
	$SQL_MAIN = "
		select * from master_regionmember A inner join master_branch B on 
		A.mbranch_id  = B.branch_id 
		where A.region_id= '$region_id' and branch_city = '$area_id'";	

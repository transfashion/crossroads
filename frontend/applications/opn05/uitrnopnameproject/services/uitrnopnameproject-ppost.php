...
if (!defined('__SERVICE__')) {
	...
	$sql = "select * from transaksi_opnameproject where opnameproject_id='$__ID'";
	$rs  = $conn->Execute($sql);
	...
	try {
		...
		if ($__ACTION=='POST' || $__ACTION=='UNPOST') {
			...
			if (!$failed) {
				...
				$obj->log_table		= "transaksi_opname";

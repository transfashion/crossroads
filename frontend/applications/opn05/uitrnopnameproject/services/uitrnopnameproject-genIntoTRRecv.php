			...
			foreach ($arr_hemoving_id as $hemoving_id) {
				...
				if ($hemoving_id) {
                	...
                	FROM (
                			...
                			B01,B02,B03,B04,B05,B06,B07,B08,B09,B10,B11,B12,B13,B14,B15,B16,B17,B18,B19,B20,B21,B22,B23,B24,B25
                			from transaksi_hemovingdetil where hemoving_id = @hemoving_id
                	) X
                	UNPIVOT
                	(qty FOR colname IN (B01,B02,B03,B04,B05,B06,B07,B08,B09,B10,B11,B12,B13,B14,B15,B16,B17,B18,B19,B20,B21,B22,B23,B24,B25))
                	AS Y
                	WHERE qty > 0

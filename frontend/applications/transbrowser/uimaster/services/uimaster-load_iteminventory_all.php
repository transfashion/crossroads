...
if (is_array($objCriteria)) {
	...
	SQLUTIL::BuildCriteria(&$SQL_CRITERIA, $DB_CRITERIA, 'obj_chk_isassemblyproduct', 'iteminventory_isassembly', " %s = '%s' ");
...
while (!$rs->EOF) {
	...
	$unit = $rs->fields['iteminventoryunit_id'];

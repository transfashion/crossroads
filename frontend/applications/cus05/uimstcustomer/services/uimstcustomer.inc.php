<?php
	...
	$__CONF['D']['DetilPurchase']['TABLE_NAME']	= "master_customerpurchase";
	$__CONF['D']['DetilPurchase']['PRIMARY_KEY1']= "customer_id";
	$__CONF['D']['DetilPurchase']['PRIMARY_KEY2']= "customerpurchase_line";	
